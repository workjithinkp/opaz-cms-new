  ...
  return (
    <section
      ...
      <div className="relative z-30 container mx-auto flex flex-col justify-center space-y-6">
        <h2
          ref={titleRef}
          className={`mb-4 text-3xl text-[#b0ddfc] uppercase lg:mb-8 lg:text-6xl 2xl:text-[80px] ${
          ...
          <div className="grid grid-cols-2 gap-4 pb-4 lg:pb-0" ref={boxesRef}>
            {items.map((item) => (
              <button
                ...
                className={`cursor-pointer rounded-xl p-3 text-sm uppercase transition duration-300 lg:p-6 lg:text-base ${
                  active === item.id
                    ? 'bg-[#B0DDFC]'
